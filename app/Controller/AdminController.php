	...
	class AdminController extends AppController {
		...
		public function lock_delete_categorie($id_categorie){
		    ...
		    if(!empty($id_categorie)){
                ...
                //Delete Folder
                $categorie = $this->CategoriesPhoto->find("first",array("conditions" => array('CategoriesPhoto.id' => $id_categorie)));

                if(!empty($categorie))
                    self::deleteDir(WWW_ROOT.'files/photo/'.$categorie['CategoriesPhoto']['slug']);
